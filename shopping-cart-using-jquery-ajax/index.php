<?php $title='A shopping cart using jQuery and ajax'; include(__DIR__ . '/../incl/header.php'); ?>

<div id='flash'>
  <h1>The bookshop for the javascripter</h1>
  <div id='cart'>
    <h2><img src="../image/bok/cart.png" width="40px">Shopping cart</h2>
    <div id='content'></div>
    <p>
      Items in cart: <span id="numitems">0</span><br/>
      Total is: <span id="sum">€0</span><br/><br/>
      <input id="clear" type="button" value="Clear" />  <a href='../checkout/index.php'><input id="checkout" type="button"  value="Till kassan"/></a>  <p id="status">Nothing has happened yet. Make a purchase.</span>
    </p>
  </div>
  <table>
